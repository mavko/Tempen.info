...
skel.registerPlugin("layers", function(e) {
    function an(e, r, i) {
        ...
        this.id = e, this.index = i, this[n] = {
            ...
            swipeToClose: kt,
            clickToClose: P
        }, t._.extend(this[n], r), this[z] = t._.newDiv(this[n].html), this[z].id = e, this[z]._layer = this, this[s] = A, this[st] = A, this[it] = A, this[Xt] = P, u = t._.cacheElement(this.id, this[z], Z, 1), u.onAttach = function() {
    ...
    var t, n = "config",
        ...
        on = "#",
        un = "*";
    return typeof e == "undefined" ? P : (e.fn[xt] = function() {
        ...
        return s = e(this), isNaN(o = parseInt(s.data(ot))) && (o = 0), s.data(M, s[x](at))[x](at, t[n].baseZIndex + o + (r ? r : 1)), s
    }, e.fn[d] = function() {
        var t, n;
        if (this[j] > 1) {
            for (t = 0; t < this[j]; t++) e(this[t])[d]();
            return e(this)
        }
        return n = e(this), n[x](at, n.data(M)).data(M, ""), n
        ...
        var t = e(this);
        t[Tt]("class").match(/(\s+|^)([0-9]+)u(\s+|$)/) && t.data(Rt, parseInt(RegExp.$2))
    }, e.fn[St] = function() {
        var t = e(this),
            n = t.parent(),
            r = 12;
        ...
        }), r > 0 && (t[ht](), t[x](S, (t.data(Rt) + r) / 12 * 100 + "%"))
    }, an[k][bt] = {
        "top-left": {
            v: I,
            h: L,
        ...
        none: {
            activate: function(e) {
                var t = e[n],
                    r = e[s];
                r[w](0)[c](t.zIndex).show(), t[X] && r[u](), e[v]()
            },
        ...
        overlayX: {
            activate: function(e) {
                var r = e[n],
                    i = e[s];
                i[w](0)[c](r.zIndex)[x](r[Yt], Jt + t[J](t._[b](r[S])) + Vt).show(), r[X] && i[u](), t[At]("x"), e[v](), window[m](function() {
        ...
        overlayY: {
            activate: function(e) {
                var r = e[n],
                    i = e[s];
                i[w](0)[c](r.zIndex)[x](r[Yt], Jt + t[J](t._[b](r[B])) + Vt).show(), r[X] && i[u](), t[At]("y"), e[v](), window[m](function() {
                    i[o](0, (r[Yt] == y ? Jt : "") + t[J](t._[b](r[B])))
                }, 50)
            },
            deactivate: function(e) {
                var i = e[n],
        ...
        pushX: {
            activate: function(e) {
                var r = e[n],
                    a = e[s],
                    f = t[i][O].add(t[i][l][_]());
                a[w](0)[x](r[Yt], Jt + t[J](t._[b](r[S])) + Vt).show(), r[X] && a[u](), f[c](), t[At]("x"), e[v](), window[m](function() {
        ...
        pushY: {
            activate: function(e) {
                var r = e[n],
                    a = e[s],
                    f = t[i][O].add(t[i][l][_]());
                a[w](0)[x](r[Yt], Jt + t[Qt](t._[b](r[B])) + Vt).show(), r[X] && a[u](), t[At]("y"), e[v](), window[m](function() {
                    a.add(f)[o](0, (r[Yt] == y ? Jt : "") + t[Qt](t._[b](r[B])))
                }, 50)
            },
            deactivate: function(e) {
                var o = e[n],
        ...
        revealX: {
            activate: function(e) {
                var r = e[n],
                    a = e[s],
                    f = t[i][O].add(t[i][l][_]());
                a[w](0).show(), r[X] && a[u](), f[c](), t[At]("x"), e[v](), window[m](function() {
        ...
        e = this[n], r = t._[b](e[nt]), r in this[ct] || (r = mt), this[ct][r][E](this), e[Y] && e.exclusive && t[i][h] === this && (t[i][Wt].removeClass(et), t[i][h] = A), this[Xt] = P
    }, an[k][vt] = function() {
        var e, r, o, u;
        if (this[Xt]) {
            t[i][l][Ct](this[z]);
        ...
        e = this[n], r = t._[b](e[nt]), o = this[s], o[x](S, t._[b](e[S]))[x](B, t._[b](e[B])), t._[zt][F] == "ios" && e[B] == "100%" && !e[Y] && o[x](B, "-webkit-calc(" + t._[b](e[B]) + " + 70px)"), u = this[bt][e[C]], o[nn]("skel-layer-" + e[C]).data(ut, e[C]);
        switch (u.v) {
            case I:
                o[x](I, 0);
                break;
            case y:
                ...
                break;
            case T:
                o[x](I, "50%")[x]("margin-top", Jt + t.getHalf(e[B]))
        }
        switch (u.h) {
            case L:
                o[x](L, 0);
        ...
        this[ct][r][vt](this), e[Y] && e.exclusive && (t[i][Wt][nn](et), t[i][h] = this), this[Xt] = kt
    }, an[k][tt] = function() {
        return this[s] !== A
    }, an[k][Zt] = function() {
        ...
        o[D](), o[wt](un).each(function() {
            t.parseInit(e(this))
        }), o[nn]("skel-layer").data(ot, this.index)[x](at, t[n].baseZIndex)[x](C, "fixed")[x]("-ms-overflow-style", "-ms-autohiding-scrollbar")[x]("-webkit-overflow-scrolling", "touch").hide();
        ...
        r[Yt] || (r[Yt] = this[bt][r[C]][Yt]);
        if (!r[nt] || typeof r[nt] != "object" && !(r[nt] in this[ct])) r[nt] = mt;
        r.clickToClose && o[wt]("a")[x](G, It).on("click.skel-layers", function(r) {
            var i, s, o = e(this);
            if (o.hasClass("skel-layers-ignore")) return;
            r[$](), r[W](), u[E]();
            if (o.hasClass("skel-layers-ignoreHref")) return;
            i = o[Tt]("href"), s = o[Tt]("target"), window[m](function() {
            ...
            u[st] = e[rt][Kt][0].pageX, u[it] = e[rt][Kt][0].pageY
        }).on("touchmove", function(e) {
            var t, n, i, s, a, f, l;
            if (u[st] === A || u[it] === A) return;
            t = u[st] - e[rt][Kt][0].pageX, n = u[it] - e[rt][Kt][0].pageY, i = o.outerHeight(), s = o.get(0).scrollHeight - o[w]();
            if (r[Y] && r.swipeToClose) {
                a = P, f = 20, l = 50;
                switch (r[Yt]) {
                    case L:
                        a = n < f && n > -1 * f && t > l;
                ...
                if (a) return u[st] = A, u[it] = A, u[E](), P
            }
        ...
        recalcH: function(n) {
            return t.recalc(n, e(window)[B]())
        },
        getHalf: function(e) {
            var t = parseInt(e);
            return typeof e == "string" && e.charAt(e[j] - 1) == "%" ? Math.floor(t / 2) + "%" : Math.floor(t / 2) + Vt
        },
        ...
        parseInit: function(n) {
            ...
            switch (u) {
                case "toggleLayer":
                case "layerToggle":
                    n[x](G, It)[x]("cursor", "pointer"), r = function(n) {
                        n[$](), n[W]();
                ...
                case "navList":
                    l = e(on + a[0]), r = l[wt]("a"), s = [], r.each(function() {
                        var t = e(this),
                            n;
                        n = Math.max(0, t.parents("li")[j] - 1), s.push('<a class="link depth-' + n + '" href="' + t[Tt]("href") + '"><span class="indent-' + n + '"></span>' + t.text() + "</a>")
                    }), s[j] > 0 && n.html("<nav>" + s.join("") + "</nav>");
                    break;
                case "copyText":
                ...
                case "moveElement":
                    l = e(on + a[0]), o[f] = function() {
                        e(ft + l[Tt]("id") + '" />').insertBefore(l), n[Ct](l)
                    }, o[N] = function() {
                        e(_t + l[Tt]("id")).replaceWith(l)
                    }, o[f]();
                    break;
                case "moveCell":
                    l = e(on + a[0]), c = e(on + a[1]), o[f] = function() {
                        e(ft + l[Tt]("id") + '" />').insertBefore(l), n[Ct](l), l[x](S, Pt), c && c[St]()
                    }, o[N] = function() {
                        e(_t + l[Tt]("id")).replaceWith(l), l[x](S, ""), c && c[x](S, "")
                    }, o[f]();
                    break;
                default:
            }
        ...
        lockView: function(e) {
            t[i][R][Dt] = t[i][R][w](), t._[zt][Lt] && t[i][Wt][x](Gt + e, Y), t[i][O].on(q, function(e) {
                e[$](), e[W](), t[i][h] && t[i][h][E]()
        ...
        initLayers: function() {
            var r, s, o, u = 1;
            t._[qt](t[n][Nt], function(r) {
                var s;
                if (!t[n][Nt][r].html && (s = e(on + r))[j] == 0) return;
                o = new an(r, t[n][Nt][r], u++), t[i][Nt][r] = o, s && (s[_]()[Ut](o[z]), s.remove())
            })
        },
        initTransforms: function() {
            if (t[n][U]) e.fn[r] = function() {
                ...
                return e(this)[x]("backface-visibility", Y)[x]("perspective", "500")[Ht]("transition", "transform " + t[n][yt] / 1e3 + "s ease-in-out")
            };
            else {
                var s, u = [];
                t[i][R].resize(function() {
                    ...
                    var o, f, l, c;
                    r = parseInt(r), s = parseInt(s), r != 0 ? (t[i][Wt][x](V, Y), t[i][O][x](S, t[i][R][S]())) : l = function() {
                    ...
                    for (o = 0; o < this[j]; o++) {
                        var h = this[o],
                            ...
                            d;
                        if (!u[h.id])
                            if (d = an[k][bt][p.data(ut)]) {
                                u[h.id] = {};
                                switch (d.v) {
                                    case T:
                                    case I:
                                        u[h.id][I] = parseInt(p[x](I));
                                        break;
                                    case y:
        ...
        initObjects: function() {
            t[i][R] = e(window), t[i][R].load(function() {
                ...
                t[i][Wt] = e(Wt), t[i][Wt].wrapInner('<div id="skel-layers-wrapper" />'), t[i][O] = e("#skel-layers-wrapper"), t[i][O][x](C, en)[x](L, "0")[x](g, "0")[x](I, "0")[D](), t[i][H] = e('<div id="skel-layers-inactiveWrapper" />')[Ut](t[i][Wt]), t[i][H][x](B, "100%"), t[i][l] = e('<div id="skel-layers-activeWrapper" />')[Ut](t[i][Wt]), t[i][l][x](C, en), t._[pt](Z, t[i][H][0]), t._[pt]("skel_layers_activeWrapper", t[i][l][0]), t._[pt]("skel_layers_wrapper", t[i][O][0]), e("[autofocus]").focus()
            })
        },
        ...
        refresh: function() {
            e(".skel-layers-fixed")[D]()[Ut](t[i][l])
        },
        activate: function(e) {
            t._[Mt](function() {
                t[i][Nt][e][vt]()
